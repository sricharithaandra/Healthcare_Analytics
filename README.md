...
- Model performance was limited by the synthetic nature of the dataset — available variables were not strong enough predictors of test results or length of stay.
